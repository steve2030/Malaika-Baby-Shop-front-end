...
import Baby from "../assests/images/baby.jpg";
...
const Hero = () => {
  return (
    <Container>
      <Wrapper>
        <InfoContainer>
          <Title>Parenting Made Easier </Title>
          <Description>
           Committed to ensure that the little angels get the best services
          </Description>
          <InputContainer>
            <Input />
